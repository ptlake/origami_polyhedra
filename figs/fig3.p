...
plot f(0.25 * x0, 0.25 * x0, t), f(0., y0, t) lw 1 lc rgb 'black' not,\
     ...
     f(0.50 * x0, 0.50 * x0, t), f(y1 / 3., y0 - y1 / 3., t) lw 6 lc rgb 'black' not,\
     f(0.75 * x0, 0.75 * x0, t), f(0., y0, t) lw 1 lc rgb 'black' not,\
     f( x0 - (2. / 3. * 0.75 * x0 + 0.1 * x0 * 0.75 / y1), x0 - (2. / 3. * 0.75 * x0 - 0.1 * 0.75 * x0 / y1), t), f(y0 - (y1 / 3. - 0.1), y0 - (y1 / 3. + 0.1), t) lw 1 lc rgb 'black' not,\
