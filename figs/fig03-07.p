...
plot f(0.25 * x0, 0.25 * x0, t), f(5. * y2 / 6., y0, t) lw 4 lc rgb 'black' dt 6 not,\
     f(0.25 * x0, 0.625 * x0, t), f(y2 / 2., y2 / 4., t) lw 4 lc rgb 'black' dt 6 not,\
     f(0.25 * x0, 0.75 * x0, t), f(y2 / 2., y2 / 2., t) lw 4 lc rgb 'black' dt 4 not,\
     f(0.50 * x0, 0.50 * x0, t), f(2. * y2 / 3., y0, t) lw 1 lc rgb 'black' not,\
     f(0.75 * x0, 0.75 * x0, t), f(0., y0, t) lw 1 lc rgb 'black' not,\
     f(0., 0.5 * x0, t), f(y2, 0., t) lw 3 lc rgb 'black' not,\
     f(0.5 * x0, 0.75 * x0, t), f(0., y2 / 2., t) lw 3 lc rgb 'black' not,\
     f(0.75 * x0, 0., t), f(y2 / 2., y2, t) lw 3 lc rgb 'black' not,\
