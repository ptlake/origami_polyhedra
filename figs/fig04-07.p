...
plot f(0.98 * y2, y2, t), f(y2 - x0 / 2., y2 - x0 / 2., t) lw 1 lc rgb 'black' not,\
f(0.50 * x0, 0.5 * x0, t), f(0.95 * y1 / 3., y2, t) lw 1 lc rgb 'black' not,\
     f(0.50 * x0, 0.50 * x0, t), f(y2, y0, t) lw 1 lc rgb 'black' not,\
     f(0.75 * x0, 0.75 * x0, t), f(0., y0, t) lw 1 lc rgb 'black' not,\
f(0.25 * x0, 0.485 * x0, t), f(y2 - 0.25 * x0, 0.95 * y1 / 3., t) lw 3 lc rgb 'black' not,\
f(0.5 * x0, y2, t), f(0.95 * y1 / 3., 0., t) lw 3 lc rgb 'black' not,\
     f(y2, x0, t), f(y1 / 3., y1 / 3., t) lw 1 lc rgb 'black' not,\
     f(0.485 * x0, y2, t), f(y2 - x0 / 4., y2 - x0 / 4., t) lw 3 lc rgb 'black' not,\
     f(0.25 * x0, 0.25 * x0, t), f(y2 - 0.25 * x0, y0, t) lw 3 lc rgb 'black' not,\
f(0.485 * x0, 0.485 * x0, t), f(0.95 * y1 / 3., 0.985 * y0, t) lw 3 lc rgb 'black' not,\
f(0.485 * x0, 0.98 * y2, t), f(0.95 * y1 / 3., 0.95 * y1 / 3., t) lw 3 lc rgb 'black' not,\
     f(x0, x0, t), f(0., y0, t) lw 3 lc rgb 'black' not,\
     f(y2, x0, t), f(0., 0., t) lw 3 lc rgb 'black' not,\
f(y2, y2, t), f(0., y2 - 0.25 * x0, t) lw 3 lc rgb 'black' not,\
f(0.98 * y2, y2, t), f(0.95 * y1 / 3., y2 - 0.25 * x0, t) lw 3 lc rgb 'black' not,\
