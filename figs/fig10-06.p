...
plot f(0.50 * x0, 0.50 * x0, t), f(2. * y2 * cos(phi)**2 * (x2 - 0.50 * x0) / (x2 - x3), y0, t) lw 1 lc rgb 'black' not,\
     f(0.75 * x0, 0.75 * x0, t), f(2. * y2 * cos(phi)**2 * (x2 - 0.75 * x0) / (x2 - x3), y0, t) lw 1 lc rgb 'black' not,\
     f(x3 + (x2 - x3) * (1. - y1 / (6. * y2 * cos(phi)**2)), x0, t), f(y1 / 3., y1 / 3., t) lw 1 lc rgb 'black' not,\
     ...
     f(0.50 * x0, 0.50 * x0 * (1. - cos(2. * phi)), t), f(y1 / 3., y1 / 3. + 0.5 * x0 * sin(2.*phi), t) lw 1 lc rgb 'black' not,\
     f(0.25 * x0, 0.25 * x0, t), f(2. * y2 * cos(phi)**2, y0, t) lw 4 lc rgb 'black' dt 6 not,\
     f(0.25 * x0, x3 + y2 * (x2 - x3) / x2 * sin(2. * phi), t), f(y2 * (x2 - x3) / x2, 2. * y2 * (x2 - x3) / x2 * cos(phi)**2, t) lw 4 lc rgb 'black' dt 6 not,\
     f(0.25 * x0, 0.50 * x0 * (1. - cos(2. * phi)), t), f(y2 * (x2 - x3) / x2, y1 / 3. + 0.5 * x0 * sin(2.*phi), t) lw 4 lc rgb 'black' dt 4 not,\
     f(0., x2, t), f(y2, 0., t) lw 3 lc rgb 'black' not,\
     ...
     f(x2, y2 * cos(0.5 * pi - 2. * phi), t), f(0., y2 + y2 * sin(0.5 * pi - 2. * phi), t) lw 4 lc rgb 'black' not,\
