...
plot f(0.25 * x0, 0.94 * 0.5 * x0, t), f(y2 - 0.25 * x0, y1 / 3., t) lw 3 lc rgb 'black' not,\
     f(0.5 * x0, 1.06 * 0.5 * x0, t), f(y1 / 3., y1 / 3. - 0.06 * 0.50 * x0, t) lw 3 lc rgb 'black' not,\
     f(0.94 * 0.5 * x0, 1.06 * 0.5 * x0, t), f(y2 - x0 / 4., y2 - x0 / 4., t) lw 3 lc rgb 'black' not,\
     f(0.94 * 0.5 * x0, 1.06 * 0.5 * x0, t), f(y1 / 3., y1 / 3., t) lw 3 lc rgb 'black' not,\
f(0.50 * x0, 0.50 * x0, t), f(y1 / 3., 0.6 * y0, t) lw 4 lc rgb 'black' dt 6 not,\
     ...
     f(0.25 * x0, 0.25 * x0, t), f(y2 - 0.25 * x0, 0.6 * y0 + 0.09, t) lw 3 lc rgb 'black' not,\
