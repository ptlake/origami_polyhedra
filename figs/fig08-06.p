...
plot f(0.50 * x0, 0.50 * x0, t), f(2. * y2 * cos(phi)**2 * (x2 - 0.50 * x0) / (x2 - 0.25 * x0), y0, t) lw 1 lc rgb 'black' not,\
     ...
     f(0.25 * x0, 0.25 * x0 + y2 * (x2 - 0.25 * x0) / x2 * sin(2. * phi), t), f(y2 * (x2 - 0.25 * x0) / x2, 2. * y2 * (x2 - 0.25 * x0) / x2 * cos(phi)**2, t) lw 4 lc rgb 'black' dt 6 not,\
     f(0.25 * x0, 0.50 * x0 * (1. - cos(2. * phi)), t), f(y2 * (x2 - 0.25 * x0) / x2, y1 / 3. + 0.5 * x0 * sin(2.*phi), t) lw 4 lc rgb 'black' dt 4 not,\
