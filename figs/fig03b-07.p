...
set arrow from 3. * x0 / 4. + r * sin(0.89*0.7), 0.6 * y0 + r * cos(0.89*0.7) to 3. * x0 / 4. + r * sin(0.9*0.7), 0.6 * y0 + r * cos(0.9*0.7) size 0.1,30 fixed lc rgb 'black' lw 3
set arrow from 3. * x0 / 4. - r * sin(0.89*0.7), 0.6 * y0 + r * cos(0.89*0.7) to 3. * x0 / 4. - r * sin(0.9*0.7), 0.6 * y0 + r * cos(0.9*0.7) size 0.1,30 fixed lc rgb 'black' lw 3
...
plot f(0.50 * x0, 0.50 * x0, t), f(y1 / 3. + y2 / 3., y0, t) lw 1 lc rgb 'black' not,\
     ...
     3. * x0 / 4. + r * sin(0.9*f(-0.7, 0.7, t)), 0.6 * y0 + r * cos(0.9*f(-0.7, 0.7, t)) lw 3 lc rgb 'black' not
