...
plot f(0.50 * x0, 0.50 * x0, t), f(2. * y2 * cos(phi)**2 * (x2 - 0.50 * x0) / (x2 - x3), y0, t) lw 1 lc rgb 'black' not,\
     ...
     f(x2, 0.94 * 0.5 * x0, t), f(0., 1.06 * (2. * y2 * cos(phi)**2 * (x2 - 0.50 * x0) / (x2 - x3)), t) lw 4 lc rgb 'black' not,\
     f(0.25 * x0, 0.25 * x0, t), f(y2 * (x2 - x3) / x2, y0, t) lw 3 lc rgb 'black' not,\
     f(0.25 * x0, 0.94 * 0.50 * x0, t), f(y2 * (x2 - x3) / x2, y2 * (x2 - 0.50 * x0) / x2, t) lw 3 lc rgb 'black' not,\
     f(0.96 * (0.50 * x0 + y2 * (x2 - 0.50 * x0) / x2 * sin(2. * phi)), 0.94 * 0.5 * x0, t), f(2. * y2 * (x2 - 0.50 * x0) / x2 * cos(phi)**2, 1.03 * (2. * y2 * cos(phi)**2 * (x2 - 0.50 * x0) / (x2 - x3)), t) lw 3 lc rgb 'black' not,\
